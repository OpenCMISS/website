(function(){
    window.opencmisslibscomponents = {};
    ...
    window.opencmisslibscomponents.SourceCodeBox = React.createClass({
	render: function(){
    ...
    window.opencmisslibscomponents.INSTRUCTIONS_MAP = {"windows":WindowsInstall,
	    "mac":MacInstall,
	    "linux":LinuxInstall};
}());
